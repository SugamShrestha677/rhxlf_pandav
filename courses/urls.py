...
from .views import (
    ...
    StudentDashboardAPIView, StudentProgressAPIView, StudentAttendanceAPIView, CoursePaymentViewSet,
...
urlpatterns = [
    ...
    path('student/progress/', StudentProgressAPIView.as_view(), name='student-progress'),
